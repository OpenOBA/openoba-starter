...
> 完整 License Key 机制详见 / Full License Key mechanism: [operations/license-key-plan.md](../operations/license-key-plan.md)
...
1.1 **"软件"** 指 OpenOBA Core 仓库（[github.com/openoba/core](https://github.com/openoba/core)）中的全部源代码、文档、配置、相关工具。
...
10.2 **责任上限**：许可方在本协议项下的**累计责任**不超过被许可方**过去 12 个月**实际支付的费用。
...
1.1 **"Software"** means all source code, documentation, configurations, and related tools in the OpenOBA Core repository ([github.com/openoba/core](https://github.com/openoba/core)).
...
10.2 **Liability cap**: Licensor's **aggregate liability** under this agreement shall not exceed the **fees actually paid by Licensee in the past 12 months**.
