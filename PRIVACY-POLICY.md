...
1. **下载、安装、使用 OpenOBA 软件**（包括 openoba/core、openoba/starter、openoba/erdl 三个仓库）；
...
| 接收方 | 场景 | 数据范围 | 法律基础 |
|--------|------|----------|----------|
| **阿里云** | 遥测存储、数据库 | 全部遥测 | DPA / GDPR Art 28 |
...
| **收购方** | 公司并购、重组 | 全部个人信息 | PIPL 20/21、GDPR Art 21 |
...
8.1 我们的**主服务器**位于**中国深圳（阿里云）**，主处理在境内。
...
1. Downloading, installing, using OpenOBA software (openoba/core, openoba/starter, openoba/erdl);
