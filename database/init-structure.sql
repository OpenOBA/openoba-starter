...
CREATE TABLE IF NOT EXISTS `product_spu` (
  ...
  `scene_tags` json DEFAULT NULL COMMENT '场景标签',
  `description` text COMMENT '描述',
  `main_image` varchar(512) DEFAULT NULL COMMENT '【废弃 2026-06-17】主图URL — 改用 product_sku_image 表',
  `images` json DEFAULT NULL COMMENT '【废弃 2026-06-17】图片列表 — 改用 product_sku_image 表',
  `attributes` json DEFAULT NULL COMMENT '扩展属性',
