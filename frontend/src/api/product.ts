...
export function deleteSku(id: string) { return request.delete(`/products/skus/${id}`); }
...
export function updatePromotionStatus(id: string, status: string) { return request.put(`/pricing/promotions/${id}/status`, { status }); }
export function calculatePrice(data: CreateUpdateData) { return request.post('/pricing/calculate', data); }
...
export function deleteSet(id: string) { return request.delete(`/products/sets/${id}`); }

// ===== SKU 图片 =====
export function getSkuImages(params?: QueryParams) { return request.get('/products/sku-images', { params }); }
export function getSkuImage(id: string) { return request.get(`/products/sku-images/${id}`); }
export function getSkuImagesGrouped(skuId: string) { return request.get(`/products/sku-images-grouped/${skuId}`); }
export function createSkuImage(data: CreateUpdateData) { return request.post('/products/sku-images', data); }
export function batchCreateSkuImages(data: { skuId: string; images: CreateUpdateData[] }) { return request.post('/products/sku-images/batch', data); }
export function updateSkuImage(id: string, data: CreateUpdateData) { return request.put(`/products/sku-images/${id}`, data); }
export function deleteSkuImage(id: string) { return request.delete(`/products/sku-images/${id}`); }
...
// ===== S-SKU 副品管理 =====
export function getSubSkus(params?: QueryParams) { return request.get('/sub-skus', { params }); }
export function getSubSku(id: string) { return request.get(`/sub-skus/${id}`); }
export function createSubSku(data: CreateUpdateData) { return request.post('/sub-skus', data); }
export function updateSubSku(id: string, data: CreateUpdateData) { return request.put(`/sub-skus/${id}`, data); }
export function deleteSubSku(id: string) { return request.delete(`/sub-skus/${id}`); }

// S-SKU 分类
export function getSubSkuCategories() { return request.get('/sub-skus/categories'); }
export function getSubSkuCategoryTree() { return request.get('/sub-skus/categories/tree'); }
export function createSubSkuCategory(data: CreateUpdateData) { return request.post('/sub-skus/categories', data); }
export function updateSubSkuCategory(id: string, data: CreateUpdateData) { return request.put(`/sub-skus/categories/${id}`, data); }
export function deleteSubSkuCategory(id: string) { return request.delete(`/sub-skus/categories/${id}`); }
