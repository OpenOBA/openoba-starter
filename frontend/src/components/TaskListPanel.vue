...
<template>
  <el-collapse v-model="activeCollapse" class="task-collapse">
    <el-collapse-item name="tasks">
      ...
      <div class="filter-bar">
        <div class="filter-left">
          ...
          <el-radio-group
            ...
            size="small"
            @change="$emit('update:filterStatus', localFilterStatus)"
          >
      ...
      <div v-if="hasMore || total > displayLimit" class="task-footer">
      ...
      <div v-if="total > pageSize && !searchKeyword" class="pagination-wrap">
        <el-pagination
