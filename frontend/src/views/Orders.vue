      ...
      <div v-if="currentOrder" class="detail-content">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="订单总额"
            >¥{{ Number(currentOrder.totalAmount).toFixed(2) }}</el-descriptions-item
          >
          <el-descriptions-item label="优惠金额"
            >-¥{{ Number(currentOrder.discountAmount).toFixed(2) }}</el-descriptions-item
          >
          <el-descriptions-item label="运费">+¥{{ Number(currentOrder.shippingFee).toFixed(2) }}</el-descriptions-item>
          <el-descriptions-item label="实付金额"
            ><b>¥{{ Number(currentOrder.actualAmount).toFixed(2) }}</b></el-descriptions-item
          >
