  ...
  <div class="erdl-management">
    ...
    <el-card class="main-card">
      <el-tabs v-model="activeTab">
        ...
        <el-tab-pane label=" Entity 管理" name="entities">
          <el-table v-loading="loading" :data="entities" stripe>
            ...
            <el-table-column label="操作" width="120" fixed="right">
              <template #default="{ row }">
                <el-button type="primary" link size="small" @click="viewSchema(row)"> Schema </el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-tab-pane>
        ...
        <el-tab-pane label=" 规则管理" name="rules">
          ...
          <el-table v-loading="loading" :data="filteredRules" stripe>
            ...
            <el-table-column label="启用" width="80">
              <template #default="{ row }">
                <el-switch v-model="row.isActive" :loading="row._toggling" @change="handleToggle(row)" />
              </template>
            </el-table-column>
        ...
        <el-tab-pane label=" Schema 查看器" name="schemas">
          <el-select
            ...
            placeholder="选择 Entity 查看 Schema"
          ...
          <el-table v-if="selectedSchema" :data="selectedSchema?.fields || []" stripe>
        ...
        <el-tab-pane label=" 智能推荐" name="recommend">
          ...
          <el-button type="primary" size="large" @click="showRecommend = true"> 打开智能推荐 </el-button>
        </el-tab-pane>

        <!-- 知识库 -->
        <el-tab-pane label=" 知识库" name="knowledge">
          <el-table v-loading="loading" :data="knowledgeBases" stripe>
    ...
    >
      ...
      <template #footer>
        ...
        <el-button type="primary" :loading="ruleSaving" @click="handleSaveRule">
          {{ isEditMode ? '保存' : '创建' }}
        </el-button>
      </template>
    </el-dialog>
