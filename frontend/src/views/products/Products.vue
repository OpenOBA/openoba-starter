...
const {
  schemaData, genderOptions, statusOptions, tierList, genderTagTypes, genderLabels,
  ...
  loadSpus, openSpuDialog, onSpuDialogSaved, batchEditSpus, batchDeleteSpus,
  ...
  structureStandardList, computedSeriesList, sceneTagOptions, categoryList,
  techDictsData,
  activeTab, init,
} = products
...
.tech-table td { padding: 6px 8px; border: 1px solid #ebeef5; font-size: 13px; }
.tech-table .tech-label { background: #f5f7fa; font-weight: 600; color: #606266; width: 90px; padding-left: 28px; white-space: nowrap; }
.tech-table .tech-value { min-width: 140px; color: #303133; }
</style>
