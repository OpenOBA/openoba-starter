    ...
    <el-tab-pane label="交付物" name="deliverables">
      <el-form label-width="160px" size="small">
        ...
        <el-form-item label="自动创建版本目录"
          ><el-switch v-model="s.deliverables.autoCreateVersionDir" /><span class="form-tip"
            >交付时自动创建 V{n}/ 子目录</span
          ></el-form-item
        >
        <el-form-item label="自动生成交付清单"
          ><el-switch v-model="s.deliverables.autoGenerateManifest" /><span class="form-tip"
            >每版本生成 manifest.json</span
          ></el-form-item
        >
        <el-form-item label="自动更新总索引"
          ><el-switch v-model="s.deliverables.autoUpdateIndex" /><span class="form-tip"
            >更新 _index.json</span
          ></el-form-item
        >
        <el-form-item label="自动写入时间线"
          ><el-switch v-model="s.deliverables.autoWriteTimeline" /><span class="form-tip"
            >追加 timeline.md</span
          ></el-form-item
        >
        <el-divider />
...
defineProps<{
  s: {
    ...
    files: { tempRetentionDays?: number; maxUploadSizeMB?: number; exportFormats?: string[] }
    [key: string]: unknown
  }
