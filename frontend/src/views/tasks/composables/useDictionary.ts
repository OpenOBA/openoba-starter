...
const dictFieldConfigs: Record<string, { keyField: string; labelField: string; fields: Record<string, unknown>[] }> = {
  dict_customer_type: { keyField: 'code', labelField: 'name', fields: [
  ...
  dict_customer_level: { keyField: 'code', labelField: 'name', fields: [
  ...
  dict_order_status: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_payment_method: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_payment_status: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_payment_scene: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_logistics_company: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_logistics_status: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_logistics_trace_type: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_after_sale_status: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_review_status: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_after_sale_reason: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_review_tag: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_product_type: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_product_tier: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
  ...
  dict_compatibility_level: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_audit_status: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_frame_material: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '材质编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '材质名称', type: 'input', required: true },
    { key: 'sort_order', label: '排序', type: 'number' },
    { key: 'is_active', label: '启用', type: 'switch' },
  ]},
  dict_frame_type: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '框型名称', type: 'input', required: true },
    { key: 'sort_order', label: '排序', type: 'number' },
    { key: 'is_active', label: '启用', type: 'switch' },
  ]},
  dict_nose_pad: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'sort_order', label: '排序', type: 'number' },
    { key: 'is_active', label: '启用', type: 'switch' },
  ]},
  dict_hinge: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'sort_order', label: '排序', type: 'number' },
    { key: 'is_active', label: '启用', type: 'switch' },
  ]},
  dict_surface_treatment: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'sort_order', label: '排序', type: 'number' },
    { key: 'is_active', label: '启用', type: 'switch' },
  ]},
  lens_shape: { keyField: 'code', labelField: 'name', fields: [
  ...
  lens_series: { keyField: 'code', labelField: 'name', fields: [
  ...
  lens_material: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '材质编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '材质名称', type: 'input', required: true },
    { key: 'name_en', label: '英文名称', type: 'input' },
  ...
  dict_product_status: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_promotion_status: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_sku_status: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'sort_order', label: '排序', type: 'number' },
  ...
  dict_customer_status: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
  ...
  dict_referral_source: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
  ...
  dict_subscription_status: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
    { key: 'color', label: '标签颜色', type: 'input', placeholder: 'success/warning/danger/info' },
  ...
  dict_contact_role: { keyField: 'code', labelField: 'name', fields: [
    { key: 'code', label: '编码', type: 'input', required: true, disabled: true },
    { key: 'name', label: '名称', type: 'input', required: true },
    { key: 'description', label: '描述', type: 'textarea' },
...
const displayNameMap: Record<string, string> = {
  dict_customer_type: '客户类型', dict_customer_level: '客户等级', dict_order_status: '订单状态',
  dict_payment_method: '支付方式', dict_payment_status: '支付状态', dict_payment_scene: '支付场景',
  dict_logistics_company: '物流公司', dict_logistics_status: '物流状态', dict_logistics_trace_type: '物流追踪类型',
  dict_after_sale_status: '售后状态', dict_review_status: '评价状态', dict_after_sale_reason: '售后原因',
  dict_review_tag: '评价标签', dict_product_type: '商品类别', dict_product_tier: '产品等级',
  dict_frame_material: '镜框材质', dict_frame_type: '镜框框型', dict_nose_pad: '鼻托类型',
  dict_hinge: '铰链类型', dict_surface_treatment: '表面处理', dict_compatibility_level: '兼容等级',
  dict_audit_status: '审核状态', structure_shape: '造型字典', structure_series: '系列字典',
  structure_material: '材质字典', dict_product_status: '商品状态', dict_promotion_status: '促销状态',
  dict_sku_status: 'SKU状态', dict_customer_status: '客户状态', dict_referral_source: '来源渠道',
  dict_subscription_status: '订阅状态', dict_contact_role: '联系人角色', dict_effect_tag: '效果标签',
  dict_sku_color: 'SKU色彩', dict_refractive_index: '折射率', dict_lens_function: '镜片功能',
  dict_lens_coating: '镜片膜层', dict_lens_material: '镜片材质', dict_unit: '计量单位', dict_brand: '品牌',
}
...
export function useDictionary() {
    ...
    try {
      ...
      if (config) {
        dictColumns.value = config.fields.map((f: Record<string, unknown>) => ({
          prop: String(f.key ?? ''), label: String(f.label ?? ''), width: f.key === 'sort_order' ? 80 : undefined,
        }))
      } else if (dictData.value.length > 0) {
        const allKeys = Object.keys(dictData.value[0])
        dictColumns.value = allKeys.filter(k => !['id', 'created_at', 'updated_at', 'deleted_at'].includes(k)).map(k => ({ prop: k, label: k }))
      }
    } catch (e: unknown) {
      const err = e instanceof Error ? e.message : String(e)
      dictData.value = []; dictColumns.value = []
  ...
  async function onSave() {
    ...
    for (const f of config.fields) {
      const k = String(f.key ?? '')
      if (f.required && !form.value[k]) { ElMessage.warning(`${f.label} 不能为空`); return }
    }
    saving.value = true
    try {
  ...
  return {
    loading, dataLoading, dictList, selectedDict, dictData, dictSelection, dictColumns,
    dialogVisible, dialogTitle, form, formFields, saving, editMode,
    getFormConfig, onSelectDict, openAdd, openEdit, onSave, onBatchEdit, onBatchDelete,
  }
}
