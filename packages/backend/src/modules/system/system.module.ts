...
@Module({
  imports: [
    TypeOrmModule.forFeature([
      User, UserRole, Role, RolePermission, Permission, Menu, AgentManifest, AuditLog,
      ModelKey, ModelKeyModels, ModelRegistry, ModelProvider, TokenUsage, ModelConnectionLog,
    ]),
  ],
  providers: [
    UserService, RoleService, PermissionService, MenuService,
    AgentManifestService, AuditLogService, DeploymentService,
    EntitySyncService, WizardService, ModelRegistryService,
  ],
  controllers: [
    UserController, RoleController, PermissionController, MenuController,
    AgentManifestController, AuditLogController, DeploymentController,
    VersionController, LlmConfigController, WizardController,
  ],
  exports: [
    UserService, RoleService, PermissionService, MenuService,
    AgentManifestService, AuditLogService, DeploymentService,
    EntitySyncService, ModelRegistryService, TypeOrmModule,
  ],
})
